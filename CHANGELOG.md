...
- Starting a new pattern or opening another one now warns you first when the
  current canvas has unsaved work (autosave only keeps the most recent pattern),
  with a one-click "Save a copy" before discarding.
...
[Unreleased]: https://github.com/Jithran/StitchSandbox/compare/v0.4.0...HEAD
[0.4.0]: https://github.com/Jithran/StitchSandbox/compare/v0.3.1...v0.4.0
